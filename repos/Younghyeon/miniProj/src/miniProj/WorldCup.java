...
public class WorldCup {
	...
	public WorldCup() {
		...
		while(true) {
			...
			System.out.println(" W o r l d C u p ");
			System.out.println("=================\n");
		...
		do {
			...
			System.out.println("==================");
			System.out.println("  메뉴 가짓수를 정하세요   ");
			System.out.println("[4] or [8] or [16]");
			System.out.println("==================\n");
			System.out.println(">> ");
	...
	public void worldcup(int var) {
		...
		while(arr.length == 2&&arr[0]!=null) { // 메뉴를 담은 배열의 크기가 2라면, 결승전이다. 또, 배열의 0번째 인덱스 값이 널이 아니라면 반복한다
			...
			if (Integer.parseInt(a) == 1) { // 입력받은 값이 1이라면, 배열이 0번째 인덱스값이 우승
				System.out.println("[Winner] : " + arr[0].toString());
				...
				System.out.println("[Winner] : " + arr[1].toString());
				System.out.println("");
				arr[0]=null;
				select="4";
				return; // 결승이 끝났으므로 메소드 종료
